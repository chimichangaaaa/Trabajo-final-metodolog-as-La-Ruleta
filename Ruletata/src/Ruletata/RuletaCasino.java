...
public class RuletaCasino {
    ...
    private List<String> obtenerCasillasApostadas(Jugador jugador) {
        ...
        System.out.print(jugador.getNombre() + ", ¿desea apostar a números o colores? (números/colores): ");
        String opcion = scanner.next();

        if (opcion.equalsIgnoreCase("números")) {
...
class Jugador {
    ...
    public boolean tieneApuestaGanadora(int numeroGanador) {
        ...
        if (casillasApostadas.size() == 1) {
            String color = casillasApostadas.get(0);
